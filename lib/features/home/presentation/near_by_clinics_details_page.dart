        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: const [
                _StatItem(icon: Icons.star_border, label: '4.9', subLabel: 'rating'),
                _StatItem(icon: Icons.chat_bubble_outline, label: '1,204', subLabel: 'reviews'),
                _StatItem(icon: Icons.route_outlined, label: '1.2 km', subLabel: 'distance'),
                _StatItem(icon: Icons.medical_services_outlined, label: '12', subLabel: 'departments'),
              ],
            ),
            const SizedBox(height: 24),
            ...
            RichText(
              text: const TextSpan(
                ...
                children: [
                  TextSpan(
                    text:
                        'Golden Cardiology Center is a leading facility dedicated to providing comprehensive cardiovascular care. Equipped with state-of-the-art technology... ',
                  ),
                  TextSpan(
                    text: 'view more',
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(subLabel, style: const TextStyle(fontSize: 12, color: Color(0xFF94A3B8))),
      ],
    );
  }
}
